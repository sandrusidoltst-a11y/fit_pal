...
def test_calculate_log_removes_first_item(basic_state):
    ...
    result = calculate_log_node(basic_state)
...
def test_calculate_log_empty_pending(basic_state):
...
def test_calculate_log_single_item(basic_state):
...
def test_multi_item_state_setup(basic_state):
...
def test_sequential_item_removal(basic_state):
    ...
    result2 = calculate_log_node(basic_state)
    ...
    result3 = calculate_log_node(basic_state)
