---
name: plan-feature
description: Create a comprehensive feature implementation plan with deep codebase analysis and research. Use when the user wants to plan a new feature, task, or refactor before implementing.
...
- Find relevant documentation in `docs/`, `.agent/reference/` if available
...
- Understand test organization (unit vs integration vs graph_api)
...
**Use the `docs-langchain` MCP server for LangChain, LangGraph, and LangSmith documentation.** Query it for:
- Latest API signatures and patterns for any LangGraph nodes, edges, or state changes
- LangSmith tracing and evaluation patterns
- LangChain tool and schema patterns

**Use specialized subagents when beneficial for additional external research:**
...
<Define validation commands based on project's tools>
